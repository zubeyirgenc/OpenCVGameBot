...
def main(is_four,bw=False):
    ...
    # find_harris_corners(image,I)#, k=0.05, window_size=3, threshold=10000.00
...
def find_harris_corners(input_img, I, k=0.05, window_size=3, threshold=10000.00):
    ...
    for y in range(offset, y_range):
        for x in range(offset, x_range):
            ...
            if r > threshold:
                ...
                input_img[y,x] = (0,0,255)
    
    cv2.imshow("input_img", input_img)
    cv2.waitKey(0)
    return corner_list, input_img 
